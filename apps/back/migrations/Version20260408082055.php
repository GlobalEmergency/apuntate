 ...
 */
final class Version20260408082055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id UUID NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, date_start TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, date_end TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, date_place TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
